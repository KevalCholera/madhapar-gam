 ...
 */
public class EventPhotosModel implements EventPhotosModelInt {

    @Override
    public EventPhotosModel getEventPhotoList(final RequestPresenter callback) {
        String tag = "userList";
        StringRequest userListRequest = new StringRequest(Request.Method.GET, UtilClass.getUserUrl("", false), new Response.Listener<String>() {
            @Override
                    ...
                    try {
                        ...
                        if (userObject != null) {
                            if (userObject.optInt("status") == Constants.ResponseCode.SuccessCode) {
                                ...
                                if (userList != null) {
                                    callback.onSuccessEventResponse(userList);
                                }
                            } else {
